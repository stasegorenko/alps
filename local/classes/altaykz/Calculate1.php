...
{ 
    ...
    //альпы лечение    
    const ALPS_CURE_ADULT = 18000;
    const ALPS_CURE_ADULT_HOLIDAY = 18000;
    const ALPS_CURE_CHILD = 13000;
    const ALPS_CURE_CHILD_HOLIDAY = 13000;  
	...
	const CURE_CHILD = 13000;
    const CURE_CHILD_HOLIDAY = 13000; 
    ...
    {                    
        ...
        if($if_besedka == 'true') 
		{
            if(self::isNewYear($date_start))
                die('Покупка беседок на сезон 2026-2027,  с 16 ноября по 1 апреля, включая новогодние праздники, производится только через отдел продаж''); 
        ...
        {                  
            if(self::isNewYear($date))
				die('Покупка номера на сезон 2026-2027,  с 16 ноября по 1 апреля, включая новогодние праздники, производится только через отдел продаж');   
            $season_discount = 0;  
            $discountExt = 0;
